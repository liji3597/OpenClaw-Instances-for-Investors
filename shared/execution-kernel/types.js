...
/**
 * @typedef {'CREATED'|'RISK_CHECK'|'REVIEW_PENDING'|'SIGNING'|'BROADCAST'|'CONFIRMED'|'FAILED'} OrderState
 */
...
const VALID_STATE_TRANSITIONS = Object.freeze({
    [ORDER_STATES.CREATED]: [ORDER_STATES.RISK_CHECK, ORDER_STATES.REVIEW_PENDING, ORDER_STATES.FAILED],
    [ORDER_STATES.RISK_CHECK]: [ORDER_STATES.REVIEW_PENDING, ORDER_STATES.SIGNING, ORDER_STATES.FAILED],
    [ORDER_STATES.REVIEW_PENDING]: [ORDER_STATES.RISK_CHECK, ORDER_STATES.SIGNING, ORDER_STATES.FAILED],
...
const STATE_TIMEOUTS_MS = Object.freeze({
    ...
    [ORDER_STATES.REVIEW_PENDING]: 86_400_000,
